...
const fs = require('fs');
const { PickUp, Delivered, DeliveryException, Returned } = require('../User/Model/userModel');
// const { PickUp, Delivered, DeliveryException, Returned } = require('..userModel/User/Model/userModel');
...
const setData = () => {
    ...
    fs.createReadStream('data/Sample Card Status Info - Delivered.csv')
        .pipe(csv({
            trim: true,
            quote: '"'
        }))
    ...
    fs.createReadStream('data/Sample Card Status Info - Delivery exceptions.csv')
        .pipe(csv({
            trim: true,
            quote: '"'
        }))
    ...
    fs.createReadStream('data/Sample Card Status Info - Returned.csv')
        .pipe(csv({
            trim: true,
            quote: '"'
        }))
